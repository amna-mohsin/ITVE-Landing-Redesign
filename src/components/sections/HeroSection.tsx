      ...
      <div className="relative z-10 container mx-auto px-6 text-center animate-fade-in-up">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            <span className="text-gradient animate-fade-in">Institute of</span>
            <br />
          ...
          <p className="text-xl md:text-2xl text-white/80 mb-10 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            Empowering the Next Generation with Practical Skills & Technical Expertise
            <br />
            <span className="text-primary font-semibold">Employment Through Skills</span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            ...
            <a 
              ...
              className="group relative px-8 py-4 bg-primary text-background font-semibold rounded-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:glow-primary flex items-center gap-2"
            >
            ...
            <a
              href="#programs"
              className="group glass px-8 py-4 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105 hover:bg-white/10 flex items-center gap-2"
            >
              Explore Courses
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </a>
        ...
        {/* Real Stats bar */}
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '1s' }}>
          {[
            { label: 'Founded', value: '2013' },
            { label: 'Student Alumni', value: '500+' },
